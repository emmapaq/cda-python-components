...
class DataUtil():
    ...
    Handles ActuatorData, SensorData, and SystemPerformanceData conversions.
    """
    ...
    def actuatorDataToJson(self, data: ActuatorData = None, useDecForFloat: bool = False):
        """
        Converts an ActuatorData object to JSON string.
        
        @param data The ActuatorData instance to convert.
        @param useDecForFloat If True, use Decimal for float parsing.
        @return JSON string representation of the ActuatorData object.
        """
        if not data:
    ...
    def sensorDataToJson(self, data: SensorData = None, useDecForFloat: bool = False):
        """
        Converts a SensorData object to JSON string.
        
        @param data The SensorData instance to convert.
        @param useDecForFloat If True, use Decimal for float parsing.
        @return JSON string representation of the SensorData object.
        """
        if not data:
    ...
    def systemPerformanceDataToJson(self, data: SystemPerformanceData = None, useDecForFloat: bool = False):
        """
        Converts a SystemPerformanceData object to JSON string.
        
        @param data The SystemPerformanceData instance to convert.
        @param useDecForFloat If True, use Decimal for float parsing.
        @return JSON string representation of the SystemPerformanceData object.
        """
        if not data:
    ...
    def jsonToActuatorData(self, jsonData: str = None, useDecForFloat: bool = False):
        ...
        @param useDecForFloat If True, use Decimal for float parsing.
        @return ActuatorData instance populated from the JSON string.
        """
        if not jsonData:
    ...
    def jsonToSensorData(self, jsonData: str = None, useDecForFloat: bool = False):
        ...
        @param jsonData The JSON string to convert.
        @param useDecForFloat If True, use Decimal for float parsing.
        @return SensorData instance populated from the JSON string.
        """
        if not jsonData:
            logging.warning("JSON data is empty or null. Returning null.")
            return None
    ...
    def jsonToSystemPerformanceData(self, jsonData: str = None, useDecForFloat: bool = False):
        ...
        @param jsonData The JSON string to convert.
        @param useDecForFloat If True, use Decimal for float parsing.
        @return SystemPerformanceData instance populated from the JSON string.
        """
        if not jsonData:
            logging.warning("JSON data is empty or null. Returning null.")
            return None
    ...
    def _formatDataAndLoadDictionary(self, jsonData: str, useDecForFloat: bool = False) -> dict:
        ...
        @param useDecForFloat If True, parse floats as Decimal objects.
        @return Dictionary representation of the JSON data.
        """
        # Replace single quotes with double quotes and normalize boolean values
    ...
    def _generateJsonData(self, obj, useDecForFloat: bool = False) -> str:
        ...
        @param useDecForFloat If True, use Decimal for float values (currently unused in encoding).
    ...
    def _updateIotData(self, jsonStruct, obj):
        """
        Updates an IoT data object with values from a JSON dictionary.
        
        @param jsonStruct Dictionary containing JSON data.
